...
_sensitive_ variable, e.g. income or unemployed, 
you may accidentally reveal a sensitive value of an 
individual observation. The procedure of adjusting
...
For enterprise data a threshold of 10 may be on the high side for a 500m by 500m
block, so let us change that into 5:
