...
\logo{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=-10mm,yshift=7mm] at (current page.south east) {
        \includegraphics[height=8mm]{./00tex/cbs.png}
    };
  \end{tikzpicture}

  % conference logo (bottom left)
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=-10mm,yshift=5mm] at (current page.north east) {
        \includegraphics[height=8mm]{./00tex/berlin_2024.png}
    };
  \end{tikzpicture}
}
...
\setbeamertemplate{footline}{\hfill \texttt{@edwindjonge \#sdcSpatialWavelet\phantom{fillup}}}
