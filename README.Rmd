...
_Publishing a map created using standard rastering or density estimation can reveal sensitive values at locations_.
`sdcSpatial` is an opensource R package to create spatial density (raster) maps from point data while protecting the privacy of individual observations. 
