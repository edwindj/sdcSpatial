...
\logo{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=22mm,yshift=5mm] at (current page.south west){
        \includegraphics[height=8mm]{./00tex/berlin2024.png}
    };
  \end{tikzpicture}
}
...
\setbeamertemplate{footline}{\hfill \texttt{@edwindjonge \#sdcSpatial\phantom{fillup}}}
